...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Voucher.last_edit_datetime'
        db.add_column('voucher_voucher', 'last_edit_datetime',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Voucher.last_editor'
        db.add_column('voucher_voucher', 'last_editor',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='edited_vouchers', null=True, to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Voucher.last_edit_datetime'
        db.delete_column('voucher_voucher', 'last_edit_datetime')

        # Deleting field 'Voucher.last_editor'
        db.delete_column('voucher_voucher', 'last_editor_id')
    ...
    models = {
        ...
        'voucher.voucher': {
            ...
            'human_token': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
